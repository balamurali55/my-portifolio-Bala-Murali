    ...
    >
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        <nav className="flex items-center justify-center">
          ...
          {/* <CustomLink className="ml-4" href="/Web-Features" title="Web Features" /> */}
        </nav>
        <nav
      ...
      "
        >
          ...
          <motion.a
            target={"_blank"}
            className="w-6 mx-3"
            href="https://github.com/balamurali55"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          ...
          <motion.a
            target={"_blank"}
            className="w-6 mx-3"
            href="https://www.linkedin.com/in/bala-murali-krishna-p-622183275/"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
